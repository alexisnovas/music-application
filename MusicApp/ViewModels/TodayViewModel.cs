    ...
    public class TodayViewModel : BaseViewModel
    {
        ...
        private async void OnSongSelected(Song selectedSong)
        {
            NavigationParameters navigationParameters = new NavigationParameters
            {
                ...
                { "SongImages" , selectedSong.SongImages }
            };
